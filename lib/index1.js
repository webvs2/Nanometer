(function(global, factory) {
	...
	typeof exports === 'object' && typeof module !== 'undefined' ?
		module.exports = factory : typeof define === 'function' && define.amd ? define(factory) : (global.Message =
			factory())
})(this, function() {
	'use strict'
	var PopupManager = {
	...
	let message = (...val) => {
		...
		if (!option.context) throw (
			'[message] If you use the object argument form, be aware!"Context" is required')
		//option
