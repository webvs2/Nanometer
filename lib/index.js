...
(function (global, factory) {
	...
	var storeSteward = function () {
		...
		storeSteward.prototype.push = function push(value) {
			this.store.push(value);
		};

		storeSteward.prototype.closeAll = function closeAll() {
			var _this = this;
		...
		storeSteward.prototype.closeSingle = function closeSingle(id, userOnClose) {
			var _this2 = this;
